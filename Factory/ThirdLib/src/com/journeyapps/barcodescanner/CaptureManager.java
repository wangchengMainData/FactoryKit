...
//        wc,20201224
        @Override
        public void takePic(){
            Log.d("wc","capturemanager take pic");
        }
    };
    ...
    public CameraInstance getInstance(){
    ...
    @TargetApi(23)
    public CameraInstance openCameraWithPermission() {
        if (ContextCompat.checkSelfPermission(this.activity, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_GRANTED) {
            barcodeView.resume();
            CameraInstance instance = barcodeView.getBarcodeView().getCameraInstance();
