 ...
 */
package com.gosuncn.zfyfactorytest.LCM;
...
public class LCM extends BaseActivity {
	...
	private int[] mTestImg = { R.drawable.lcm_red, R.drawable.lcm_green,
			R.drawable.lcm_blue, R.drawable.lcm_black, R.drawable.lcm_white,/* R.drawable.lcm_black_white_lump*/ };
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (imgSeq >= mTestImg.length) {
			...
			if(SHOW_RESULT_DIALOG) {
				...
				showTestResultConfirmButtonBar();
			}
		} else
			setBackgroud(imgSeq);
		return true;
	...
	private void showDialog() {
		...
		new AlertDialog.Builder(this)
				...
				.setPositiveButton(R.string.pass, mPositiveListener)

				.setNegativeButton(R.string.fail, mNegativeListener).setCancelable(false).show();
	}
