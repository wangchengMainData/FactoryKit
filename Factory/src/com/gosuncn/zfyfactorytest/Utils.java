 ...
 */
package com.gosuncn.zfyfactorytest;
...
import com.gosuncn.zfyfactorytest.Framework.PhoneProcessAgent;
...
public class Utils {
    ...
    public static void writeCurMessage(String Tag, String result) {
        ...
        FileOutputStream mFileOutputStream = null;
        String filePath = "/data/data/com.gosuncn.zfyfactorytest/files/" + CURRENT_FILE_NAME;
    ...
    public static void writeTestLog(String Tag, String result) {
        ...
        if (result != null)
            ...
            msg = Tag + "\n";// only write a string
        FileOutputStream mFileOutputStream = null;
        String filePath = "/data/data/com.gosuncn.zfyfactorytest/files/" + TESTLOG_FILE_NAME;
        File file = new File(filePath);
        file.getParentFile().mkdirs();
        if (!file.exists()) {
            try {
    ...
    /* ����FunctionItem����Ĳ���
     * ���磺parameter="path=/sys/class/leds/flashlight/brightness"
     *       parameter="service=com.gosuncn.zfyfactorytest.LightSensor.LightSensorService;ServiceDelay=3000;"
     */
    ...
    public static int getScreenTimeout(Context context, int defvalue) {
           return Settings.System.getInt(context.getContentResolver(),
                    Settings.System.SCREEN_OFF_TIMEOUT, defvalue);
    }
...
//        Utils.setSystemProperties(Values.PROP_CHARGE_DISABLE, value); // wmd
    }
