 ...
 */
package com.gosuncn.zfyfactorytest.NFC;
...
public class NFC extends BaseActivity {
    ...
    private void init() {
        ...
        if (!mNfcAdapter.isEnabled()) {
            logd("To enable NFC");
            mTextView.setText(getString(R.string.nfc_enabling));
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if ("android.nfc.action.TECH_DISCOVERED".equals(action)) {
            ...
            logd(hexString);
            mTextView.setText(getString(R.string.nfc_tag) + hexString);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (NfcAdapter.ACTION_ADAPTER_STATE_CHANGED.equals(action)) {
                ...
                case NfcAdapter.STATE_ON:
                    mTextView.setText(getString(R.string.nfc_scanning));
                    setProgressBarIndeterminateVisibility(true);
                    break;
