 ...
 */
package com.gosuncn.zfyfactorytest.CameraBack;
...
public class CameraBack extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        barcodeView.getCameraSettings().setCameraId(0);
        int camera_situation = CameraFront.FindCameraBackorFront();
        if (camera_situation == 1 || camera_situation == -2) { //only front or no camera
            fail();
    ...
    void init() {
        ...
        status_text.setText(getResources().getString(R.string.cameraback_cameratocode));
