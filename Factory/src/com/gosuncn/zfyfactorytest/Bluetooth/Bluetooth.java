 ...
 */
package com.gosuncn.zfyfactorytest.Bluetooth;

import static com.gosuncn.zfyfactorytest.Values.BLUETOOTH_SCAN_TO_SUCESS;
...
public class Bluetooth extends BaseActivity {
	...
	BaseAdapter mAdapter = new BaseAdapter() {
		...
		public View getView(int index, View convertView, ViewGroup parent) {
			...
			text.setText((!TextUtils.isEmpty(mDeviceList.get(index).getName())) ? mDeviceList.get(index).getName() + "\n"
